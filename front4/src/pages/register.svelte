                ...
                <div class="row justify-content-center">
                    <div class="col-xl-5 col-md-8">
                        <form class="bg-white  rounded-5 shadow-5-strong p-5">
                            ...
                            <!-- Password input -->
                            <div class="form-outline mb-4">
                                <input on:keypress={onKeyPress} bind:value={password} type="password" id="form1Example2"
                                       class="form-control"/>
                            ...
                            <!-- Password verify -->
                            <div class="form-outline mb-4">
                                <input on:keypress={onKeyPress} bind:value={password2} type="password"
                            ...
                            <!-- Submit button -->
                            <button on:click|preventDefault={doRegister} type="submit"
                                    class="btn btn-primary btn-block">Зарегаться
                            </button>
                            <div class="row mt-4">
